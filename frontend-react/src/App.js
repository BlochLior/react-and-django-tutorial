...
import UserVotesReviewPage from './pages/client/UserVotesReviewPage';
...
import PollClosure from './pages/admin/PollClosure';
      ...
      <Box as="main">
        <Container maxW="7xl" py={4}>
          <Routes>
            ...
            <Route path="/polls/review" element={<UserVotesReviewPage />} />
            ...
            <Route path="/admin/closure/" element={<PollClosure />} />
          </Routes> 
        </Container>
      </Box>
    </Box>
