...
describe('ReviewPage', () => {
  ...
  test('displays a message when a question has no selected answers', () => {
    ...
    // Assert that the 'No answer selected' message is displayed for the unanswered question
    expect(screen.getByText('No answer selected')).toBeInTheDocument();
  });
